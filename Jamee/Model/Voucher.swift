...
func listVoucher() -> [Voucher]{
    ...
    listVoucher.append(Voucher(voucherName: "Combo Gà rán + Pepsi chỉ 50.000 đồng", date: "01/02/2021"))
    ...
    listVoucher.append(Voucher(voucherName: "Combo Gà rán + Pepsi chỉ 50.000 đồng", date: "04/02/2021"))
